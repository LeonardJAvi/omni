...
class FrontsControllerTest < ActionController::TestCase
  ...
  test "should create front" do
    assert_difference('Front.count') do
      post :create, front: { aboutus: @front.aboutus, index: @front.index, places: @front.places, rooms: @front.rooms }
    end
  ...
  test "should update front" do
    patch :update, id: @front, front: { aboutus: @front.aboutus, index: @front.index, places: @front.places, rooms: @front.rooms }
    assert_redirected_to front_path(assigns(:front))
  end
